var showTabs = function(e){
  ...
  if(selectedTab == 'tabEstudiantes'){
    ...
    scoreCoachesLIM20171.innerHTML = averageCoaches("LIM", "2017-1").toFixed(2);
    ...
    scoreJedisLIM20171.innerHTML = averageJediMasters("LIM", "2017-1").toFixed(2);
  }
}
...
for(var i = 0; i < nameActiveStudents.length; i++) {
  var nameStudents = activeStudents("LIM", "2017-1");
